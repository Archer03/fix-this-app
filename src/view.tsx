...
const NoteItemWrapper = (props: NoteItemWrapperProps) => {
  ...
  const [mouseInDelete, setMouseInDelete] = useState(false);
  ...
  return <NotesListItem
    ...
    <NoteBtns>
      ...
      <NoteDeleteBtn
        onMouseEnter={() => setMouseInDelete(true)}
        onMouseOut={() => setMouseInDelete(false)}
